      ...
      <div className="min-h-screen bg-slate-100 p-2 md:p-6 font-sans text-gray-800">
        <div className="max-w-7xl mx-auto bg-white shadow-2xl rounded-3xl border-t-8 border-blue-900 overflow-hidden relative">
          ...
          <div className="bg-blue-900 text-white py-10 px-6 text-center">
            ...
            <p className="text-blue-200 mt-2 font-semibold underline">শিক্ষক প্রোফাইল ও পূর্ণাঙ্গ ডিজিটাল ডাটাবেস ব্যবস্থাপনা</p>
          </div>

          <div className="p-4 md:p-8">
            {/* ইনপুট ফরম - ম্যাডামের পিডিএফ-এর সব ফিল্ড এখানে আছে */}
            <form onSubmit={handleSubmit} className={`p-6 md:p-10 rounded-3xl border-2 shadow-inner transition-all ${isEditing ? 'bg-green-50 border-green-200' : 'bg-blue-50 border-blue-100'}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                 <div className="col-span-full text-blue-900 font-bold border-l-4 border-blue-900 pl-2">১. সাধারণ ও পেশাগত তথ্য</div>
                 ...
                 <div className="col-span-full text-blue-900 font-bold border-l-4 border-blue-900 pl-2 mt-4">২. শিক্ষা ও চাকুরির রেকর্ড</div>
                ...
                <tbody className="divide-y divide-gray-100">
                  {teachers.map((t) => (
                    <tr key={t._id} className="hover:bg-slate-50 transition border-b">
                      <td className="p-5"><div className="font-bold text-blue-900 text-base">{t.nameBn || t.nameBN}</div><div className="text-xs">{t.designation}</div></td>
            ...
            <footer className="bg-slate-900 text-white p-8 mt-12 border-t-4 border-blue-600 flex flex-col md:flex-row items-center gap-6">
                <div style={{ width: '40px', height: '40px' }} className="rounded-full border-2 border-blue-400 overflow-hidden bg-white">
        ...
        {/* --- সলিড হোয়াইট মাস্টার মডাল (সব তথ্যসহ) --- */}
        {selectedTeacher && (
          <div className="fixed inset-0 flex items-center justify-center p-4 z-[99999999]">
            <div className="absolute inset-0 bg-black bg-opacity-95 backdrop-blur-md" onClick={() => setSelectedTeacher(null)}></div>
            <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border-t-8 border-blue-900 relative z-[999999999]">
              ...
              <div className="p-8 md:p-12 space-y-10 bg-white">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 border-b pb-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="flex justify-between text-green-700 font-bold border-b border-dotted py-1"><strong>মূল বেতন:</strong> <span>{selectedTeacher.basicPay || 0} ৳</span></p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 border-b pb-8">
                   <div className="space-y-3">
                      ...
                      <p><strong>SSC তথ্য:</strong> <br/> <span className="text-gray-600">{selectedTeacher.eduSSC || "প্রদত্ত নয়"}</span></p>
                      <p><strong>স্নাতক তথ্য:</strong> <br/> <span className="text-gray-600">{selectedTeacher.eduGrad || "প্রদত্ত নয়"}</span></p>
                   </div>
                   <div className="space-y-3">
                      <h3 className="font-bold text-blue-900 uppercase text-xs border-b pb-1 tracking-widest">৪. ব্যাংক ও অন্যান্য</h3>
                      <p className="flex justify-between"><strong>ব্যাংকের নাম:</strong> <span>{selectedTeacher.bankName || "নেই"}</span></p>
                      <p className="flex justify-between"><strong>রাউটিং নম্বর:</strong> <span>{selectedTeacher.routingNumber || "নেই"}</span></p>
                      <p className="flex justify-between font-mono"><strong>ব্যাংক একাউন্ট:</strong> <span>{selectedTeacher.bankAcc || "নেই"}</span></p>
                   </div>
                </div>
                <p className="bg-blue-50 p-4 rounded-xl italic"><strong>বর্তমান ও স্থায়ী ঠিকানা:</strong> <br/> {selectedTeacher.presentAddr || selectedTeacher.permanentAddr || selectedTeacher.address || "প্রদত্ত নয়"}</p>
              </div>
              <div className="p-8 bg-gray-100 flex justify-center sticky bottom-0">
                <button onClick={() => setSelectedTeacher(null)} className="bg-blue-900 text-white py-4 px-20 rounded-2xl font-bold shadow-lg hover:bg-black transition-all">বন্ধ করুন</button>
              </div>
            </div>
          </div>
        )}
